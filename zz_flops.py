...
parser.add_argument('--pws', type=str, default=' ', help='The path to pretrained weight')
...
def main():
    ...
    logging.info('target model: flops {} '.format(target_flops))
    logging.info('surrogate model: flops {} '.format(surrogate_flops))
