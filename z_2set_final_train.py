...
args.save = os.path.join(args.prefix, 'z/two_set_one_test', args.save)
args.cutout = False
...
def main():
    ...
    for _ in range(2):
        ...
        utils.save(target_model, os.path.join(args.save, 'target_CIFAR_{}.pt'.format(CIFAR_CLASSES)))
        target_acc_clean, _ = target_model.test_acc_single(test_queue, logger, args)
        ...
        utils.save(surrogate_model, os.path.join(args.save, 'surrogate_model_cifar_{}.pt'.format(CIFAR_CLASSES)))
        ...
        utils.save(target_model_baseline, os.path.join(args.save, 'target_baseline_cifar_{}.pt'.format(CIFAR_CLASSES)))
        ...
        save_dict['target_genotype'] = genotype
        save_dict['surrogate_genotype'] = transformed_genotype
        torch.save(save_dict, os.path.join(args.save, 'surrogate_result_cifar_{}'.format(CIFAR_CLASSES)))
        CIFAR_CLASSES = 100
