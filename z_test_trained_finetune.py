dirs = ['predictor/finetune_dataset/May  9 06 08 46',
'predictor/finetune_dataset/May  9 06 20 54',
'predictor/finetune_dataset/May  9 06 21 06',
'predictor/finetune_dataset/May  9 06 21 18',
'predictor/finetune_dataset/May  9 06 35 20',
'predictor/finetune_dataset/May  9 06 35 49',
'predictor/finetune_dataset/May  9 06 36 03',
'predictor/finetune_dataset/May  9 06 36 07',
'predictor/finetune_dataset/May  9 06 36 13',
'predictor/finetune_dataset/May  9 06 36 53',
'predictor/finetune_dataset/May  9 06 37 07',
'predictor/finetune_dataset/May  9 06 37 37',
'predictor/finetune_dataset/May  9 06 37 45',
'predictor/finetune_dataset/May  9 06 37 51',
'predictor/finetune_dataset/May  9 06 37 56',
'predictor/finetune_dataset/May  9 06 38 05',
'predictor/finetune_dataset/May  9 06 38 12',
'predictor/finetune_dataset/May  9 06 38 31',
'predictor/finetune_dataset/May  9 06 38 48',
'predictor/finetune_dataset/May  9 06 43 32',
'predictor/finetune_dataset/May  9 06 43 37',
'predictor/finetune_dataset/May  9 06 43 57',
'predictor/finetune_dataset/May  9 06 44 10',
'predictor/finetune_dataset/May  9 06 44 28',
'predictor/finetune_dataset/May  9 06 44 42',
'predictor/finetune_dataset/May  9 06 45 29']
...
if args.debug:
    args.save = os.path.join(args.prefix, "predictor/rubbish/debug", args.save)
else:
    args.save = os.path.join(args.prefix, "predictor/rubbish", args.save)
args.cutout = False
...
def main():
    ...
    for i in range(len(dirs)):
        ...
        if not os.path.exists(os.path.join(dirs[i], str(0), 'target.pt')):
            continue

        utils.load(target_model, os.path.join(dirs[i], str(0), 'target.pt'))
        ...
        if not os.path.exists(os.path.join(dirs[i], str(0), 'target_baseline.pt')):
            continue

        utils.load(target_model_baseline, os.path.join(dirs[i], str(0), 'target_baseline.pt'))
        ...
        for j in range(4):
         ...
         args.init_channels, CIFAR_CLASSES, args.layers, criterion, device, steps=args.num_nodes, controller_hid=args.controller_hid, entropy_coeff=args.entropy_coeff, edge_hid = args.edge_hid, transformer_nfeat = args.transformer_nfeat, transformer_nhid = args.transformer_nhid, transformer_dropout = args.transformer_dropout, transformer_normalize = args.transformer_normalize, loose_end = args.loose_end, op_type=args.op_type\
            ...
            if not os.path.exists(os.path.join(dirs[i], str(0), 'surrogate_model_{}.pt'.format(j))):
                break
            utils.load(surrogate_model, os.path.join(dirs[i], str(0), 'surrogate_model_{}.pt'.format(j)))
            ...
            logging.info("num: %d absolute_reward=%.2f, relative_reward=%.2f, target_acc_clean=%.2f, surrogate_acc_clean=%.2f, acc_adv=%.2f, surrogate_acc_adv=%.2f", i,\
            ...
            data_point["target_acc_clean"] = acc_clean_
            data_point["surrogate_acc_clean"] = optimized_acc_clean_
            data_point["constrain"] = True
            data_point["train_info"] = {"index": dirs[i], "info": args.save}
            ...
            torch.save(train_data_j, os.path.join(dirs[i], str(0), 'train_data_0'))
