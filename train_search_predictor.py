...
parser.add_argument('--its', type=int, default=10000, help='number of training iteration')
...
parser.add_argument('--lr_min', type=float, default=3e-4, help='min learning rate')
...
parser.add_argument('--thre', type=int, default=10, help='hidden dimension')
...
tmp = 'train_search/train_search_predictor'
if args.debug:
